...
//			dat += "<a href='?_src_=prefs;preference=toggle_random;random_type=[RANDOM_NAME_ANTAG]'>When Antagonist: [(randomise[RANDOM_NAME_ANTAG]) ? "Yes" : "No"]</a>"
			...
			dat += "<b>Set De Estadisticas:</b> <a href='?_src_=prefs;preference=statpack;task=input'>[statpack.name]</a><BR>"
...
//			-----------START OF BODY TABLE-----------
			...
			dat += "<br><b>Inventario:</b> <a href='?_src_=prefs;preference=loadout_item;task=input'>[loadout ? loadout.name : "None"]</a>"
			dat += "</td>"
